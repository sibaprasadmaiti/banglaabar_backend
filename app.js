...
var server = app.listen(app.get("port"), function () {
  ...
  console.log("Express server listening on port ===>".bgRed + app.get("port"));
...
app.locals.adminbaseurl =  process.env.host+ app.get("port") + "/admin/";
app.locals.baseurl = process.env.host + app.get("port") + "/";
app.locals.apiurl = process.env.host + app.get("port") + "/api/v1/";
app.locals.frontendbaseurl = "http://mawfoor.com/";
//console.log(app.locals.adminbaseurl);return false;
